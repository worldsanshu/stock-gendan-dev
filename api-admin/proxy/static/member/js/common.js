!
    function () {
        ...
        function Cb(a, b) {
            var g,
                c = b || [[Db, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], [pb, [1, 2, 5, 10, 15, 30]], [Za, [1, 2, 5, 10, 15, 30]], [Qa, [1, 2, 3, 4, 6, 8, 12]], [ta, [1, 2]], [$a, [1, 2]], [Ra, [1, 2, 3, 4, 6]], [Da, null]],
                d = c[c.length - 1],
                e = D[d[0]],
                f = d[1];
            ...
            attr: function (a, b) {
                ...
                "d" !== c && "visibility" !== c && "fill" !== c && (q = parseFloat(q));
                    ...
                    for (c in a) if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                        ...
                        if ("strokeWidth" === c && (c = "stroke-width"), ("stroke-width" === c || "stroke" === c) && (this[c] = d, this.stroke && this["stroke-width"] ? (w(g, "stroke", this.stroke), w(g, "stroke-width", this["stroke-width"]), this.hasStroke = !0) : "stroke-width" === c && 0 === d && this.hasStroke && (g.removeAttribute("stroke"), this.hasStroke = !1), j = !0), this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)/.test(c) && (m || (this.symbolAttr(a), m = !0), j = !0), l && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c)) for (e = l.length; e--;) w(l[e], c, "height" === c ? r(d - (l[e].cutHeight || 0), 0) : d);
            ...
            on: function (a, b) {
                ...
                return jb && "click" === a ? (d.ontouchstart = function (a) {
                    ...
                    d.onclick = function (a) {
                        (-1 === na.indexOf("Android") || Date.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a)
                    }) : d["on" + a] = b,
                    this
            },
            ...
            button: function (a, b, c, d, e, f, g, h, i) {
                ...
                return p = e.style,
                    ...
                    j.setState = function (a) {
                        (j.state = k = a) ? 2 === a ? j.attr(g).css(n) : 3 === a && j.attr(h).css(o) : j.attr(e).css(p)
                    },
                    j.on("click",
                        function () {
                            3 !== k && d.call(j)
        ...
        ca && (Highcharts.CanVGRenderer = F = function () {
            ...
            eb.prototype = {
                ...
                init: function (a, b) {
                    ...
                    -1 === pa(this, a.axes) && (a.axes.push(this), a[c ? "xAxis" : "yAxis"].push(this)),
        ...
        Q.prototype = {
            ...
            destroy: function () {
                ...
                for (A(a, "destroy"), $(a), n(["xAxis", "yAxis"],
                    function (b) {
                        (i = a[b]) && (ga(i.series, a), i.isDirty = i.forceRedraw = !0, i.stacks = {})
            ...
            drawDataLabels: function () {
                var e, f, g, h, a = this,
                    ...
                    d = b.dataLabels,
                    b = a.points;
                (d.enabled || a._hasPointLabels) && (a.dlProcessOptions && a.dlProcessOptions(d), h = a.plotGroup("dataLabelsGroup", "data-labels", a.visible ? "visible" : "hidden", d.zIndex || 6), f = d, n(b,
                    function (b) {
            ...
            alignDataLabel: function (a, b, c, d, e) {
                var f = this.chart,
                    ...
                    i = o(a.plotY, -999),
                    j = b.getBBox();
                (a = this.visible && f.isInsidePlot(a.plotX, a.plotY, g)) && (d = s({
                        x: g ? f.plotWidth - i : h,
                ...
                getSegments: function () {
                    ...
                    if (this.options.stacking && !this.cropped) {
                        ...
                        c.sort(function (a, b) {
                            ...
                            n(c,
                                function (a) {
                                    (!k || g[a] && null !== g[a].y) && (g[a] ? b.push(g[a]) : (h = d.translate(a), l = f[a].percent ? f[a].total ? 100 * f[a].cum / f[a].total : 0 : f[a].cum, i = e.toPixels(l, !0), b.push({
                                        y: null,
                                        plotX: h,
                                        clientX: h,
                                        plotY: i,
    ...
    function (e, t) {
        ...
        e.extend(i.prototype, {
            ...
            _generateHTML: function (e) {
                var t, i, a, s, n, r, o, u, c, l, h, d, p, g, m, f, _, v, k, b, y, D, w, M, C, x, I, N, T, A, E, S, Y,
                    F, P, O, j, K, R, H = new Date,
                ...
                refresh: function (async) {
                    if (!this.disabled) {
                        ...
                        if (ie6) {
                            ...
                            !isNaN(minW) && minW > tipW ? tipW = minW : !isNaN(maxW) && tipW > maxW && (tipW = maxW),
            ...
            $.each({
                ...
                function (method, defaultEffect) {
                    $.Widget.prototype["_" + method] = function (element, options, callback) {
                        ...
                        var hasOptions,
                            effectName = options ? options === !0 || "number" == typeof options ? defaultEffect : options.effect || defaultEffect : method;
                        options = options || {},
