...
class BaseService
{
     ...
     * @return mixed
     */
    public function getLists($page = 1, $limit = 20, $where = true, $order = ['id' => 'desc'])
    {
        $page = intval($page);
        $limit = intval($limit);
        $data =  $this->model
     ...
     * @return mixed
     */
    public function getListsPaginate($limit = 20, $where = true, $order = ['id' => 'desc'])
    {
        $limit = intval($limit);
     ...
     * @return mixed
     */
    public function getListAll($where = true, $order = ['id' => 'desc'])
    {
        return $this->model
        ->field($this->allowField)
        ->where($where)
