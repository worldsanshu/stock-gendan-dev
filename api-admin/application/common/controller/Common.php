...
//         header('Access-Control-Allow-Headers:Authorization, Content-Type, If-Match, If-Modified-Since, If-None-Match, If-Unmodified-Since, X-Requested-With');
    ...
    /**
     * 获取网站标识 弃用
     * return webtype @1总站 @2代理站
     */
//     public function webTypeBak()
//     {
...
//     }
     ...
     *日记
     */
    public function Logs($file, $data = array(), $m)
    {
        Logs::log($file, $data, $m);
    }
    
    /*
     *额外多一个table
     */ 
    public function tableHtml($data)
    {
        $html = '<div class="builder-table" style="margin-bottom: 20px;">
