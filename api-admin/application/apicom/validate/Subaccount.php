...
class Subaccount extends Validate
{
    ...
    //定义验证提示
    protected $message = [
      'sub_account.require' => '{%V0042}',// '请输入子账户名称',
      'sub_account.unique' => '{%V0043}',// '该子账户名称已存在',
      'sub_account.chsDash' => '{%V0044}',// '该子账户名称格式只能是汉字、字母、数字和下划线_及破折号-',
      'sub_pwd.require' => '{%V0045}',// '请输入子账户密码',
      'sub_pwd.alphaDash' => '{%V0046}',// '该子账户名称格式只能是字母、数字和下划线_及破折号-',
      'agent_id.require' => '{%V0047}',// '请选择所属代理商',
      'account_id.require' => '{%V0048}',// '请选择证券账户名',
    ];
    //定义验证场景
    protected $scene = [
        //更新
