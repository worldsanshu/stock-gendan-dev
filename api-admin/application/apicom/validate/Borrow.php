...
class Borrow extends Validate
{
    ...
    //定义验证提示
    protected $message = [
      'order_id.require' => '{%V0028}',// '订单号不存在',
      'order_id.unique' => '{%V0029}',// '订单号已存在',
      'member_id.require' => '{%V0030}',// '会员ID不能为空',
      'multiple.require' => '{%V0031}',// '配资倍率不能为空',
      'deposit_money.require' => '{%V0032}',// '保证金不能为空',
      'borrow_money.require' => '{%V0033}',// '配资金额不能为空',
      'init_money.require' => '{%V0034}',// '初始金额金额不能为空',
      'borrow_duration.require' => '{%V0035}',// '资金使用时间不能为空',
      'loss_warn.require' => '{%V0036}',// '预警线不能为空',
      'loss_close.require' => '{%V0037}',// '止损线不能为空',
      'rate.require' => '{%V0038}',// '配资费率不能为空',
      'total.require' => '{%V0039}',// '配资总期数不能为空',
      'type.require' => '{%V0040}',// '配资类型不能为空',
      'stock_subaccount_id.require' => '{%V0041}',// '子账户必选',
    ];
    //定义验证场景
    protected $scene = [
        //新增
