...
//        parent::__construct($request);
    ...
    public function protocol()
    {
        ...
        $res = $this->islogin();
        $lang = input('lang', '');
        $info = file_get_contents(config('data_backup_path') . "contract" . $lang . ".txt");
//        file_put_contents('protocol.txt', date('Y-m-d H:i:s') . $lang . "\r\n", FILE_APPEND);
//        file_put_contents('protocol.txt', var_export($info, true) . "\r\n", FILE_APPEND);
        $arr = array(
