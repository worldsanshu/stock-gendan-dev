...
class Qrcode extends Common
{
     ...
     */
    public function generate($text = '', $file_path = 'aadw.png')
    {
        // 插件配置参数
        ...
        if ($plugin_config['logo'] > 0) {
            $plugin_config['outfile'] = $plugin_config['outfile'] === false ? 'uploads/userqrcode/' . MID . '_qrcode.png' : $plugin_config['outfile'];
